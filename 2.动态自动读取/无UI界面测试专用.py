...
if __name__ == "__main__":
    folder_path = r'D:\File\0.公司相关\1.1.黄山MOSFET\8并1200V\21.黄山B档 Datasheet制作\2.动态\BC70'
    UIInfoDict = {'HS_Vgs_act_Channel':1, 'HS_Vds_act_Channel':2, 'HS_Ids_act_Channel':0, 'HS_Idiode_pas_Channel':3, 
                ...
                'HS_Vgs_positive_voltage':18, 'HS_Vgs_negative_voltage':-1.2, 
                'LS_Vgs_positive_voltage':18, 'LS_Vgs_negative_voltage':-1.2, 
                'Is_low_pass_filter':0, 'sampling_rate':6.25e9, 'cutoff_frequency':400e6,
                'input_folder_path':folder_path, 'output_file_path':folder_path}
