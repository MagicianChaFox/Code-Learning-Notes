    ...
    def get_key_time(self, VgsR, Vgs):
        ...
        if max(G_Vge_Filtered) > Vge_high and min(G_Vge_Filtered) < Vge_low:
            ...
            while tmp < 0.7:
                ...
                #midpoint_2_var = np.var(G_Vge[tl_midpoint_2_tmp : tl_midpoint_2_tmp + 5000])
            ...
            self.tl_midpoint_2 = int(self.tl_1_off)  # 有问题的时候临时使用
            #self.tl_midpoint_2 = int(0.9 * self.tl_1_off + 0.1 *  self.tl_2_on)  # 有问题的时候临时使用
            '''
...
def GetDynamicData(module_type, VgsR, Vgs, sampling_rate):
    ...
    return_list = [Get.Ic_off, Get.tdon, Get.tr, Get.ton, Get.didt_on_01_09, Get.dvdt_on_09_01, Get.didt_on_02_08, Get.dvdt_on_08_02, Get.didt_on_03_07, Get.dvdt_on_07_03, Get.Eon,
            Get.tdoff, Get.tf, Get.toff, Get.didt_off_09_01, Get.dvdt_off_01_09, Get.didt_off_08_02, Get.dvdt_off_02_08, Get.didt_off_07_03, Get.dvdt_off_03_07, Get.Vce_stable, Get.Vpeak, Get.Eoff, Get.Eon+Get.Eoff,
            ...
            Get.didt_on_max, Get.dvdt_on_max, Get.didt_off_max, Get.dvdt_off_max, Get.time_didt_on_max, Get.time_dvdt_on_max, Get.time_didt_off_max, Get.time_dvdt_off_max, Get.time_dvdt_rrm_max, ]
    return (return_list)
